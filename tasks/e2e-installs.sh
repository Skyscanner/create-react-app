...
cd "$temp_app_path"
npx create-react-app test-app-dist-tag --scripts-version=backpack-react-scripts --template @skyscanner/backpack
...
cd "$temp_app_path"
npx create-react-app test-use-npm-flag --use-npm --scripts-version=backpack-react-scripts --template @skyscanner/backpack
...
cd "$temp_app_path"
npx create-react-app test-app-tarball-url --scripts-version=https://registry.npmjs.org/backpack-react-scripts/-/backpack-react-scripts-8.0.0-beta.41a3a687f.tgz
